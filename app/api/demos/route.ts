      ...
      .insert([
        {
          ...
          acr_breakdown: acr_breakdown || null,
          prefer_live_preview: !!prefer_live_preview,
          kpi_metrics:        Array.isArray(kpi_metrics)        ? kpi_metrics        : [],
          challenge_points:   Array.isArray(challenge_points)   ? challenge_points   : [],
          business_outcomes:  Array.isArray(business_outcomes)  ? business_outcomes  : [],
          ai_capabilities:    Array.isArray(ai_capabilities)    ? ai_capabilities    : [],
          tech_stack:         Array.isArray(tech_stack)         ? tech_stack         : [],
          agent_timeline:     Array.isArray(agent_timeline)     ? agent_timeline     : [],
          architecture_flow:  Array.isArray(architecture_flow)  ? architecture_flow  : [],
          operational_stats:  Array.isArray(operational_stats)  ? operational_stats  : [],
          featured: false,
